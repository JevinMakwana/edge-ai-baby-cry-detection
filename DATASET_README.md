...
Download the data from the following git repo link and save the 'donateacry-corpus-master' folder in the root dir of the repo on your local.
https://github.com/gveres/donateacry-corpus/tree/master
